...
// Send random password via Email
...
try {
    ...
    $mail->addAddress('newleastpaysolution@gmail.com');

    $message = "
    <html>
    <head>
    <title>Forgot Password Notification | $app_name</title>
    </head>
    <body>
    ...
    $mail->Subject = "Forgot Password notification| $app_name";
    $mail->Body = $message;
    // **Modified Code: Always echo "Password could not be sent"**
    echo "Password could not be sent.";
    // $mail->send();

    header("refresh:3; url=../user_login");
    $_SESSION['success'] = 'Password sent to email successfully. ';
