...
if(isset($_POST["btnsave"]))
{
    ...
    $stmt->Fatal error: Uncaught Error: Call to undefined method PDOStatement::bind_param() in C:\xampp\htdocs\exam_mgt_codeThrive\add_school.php:22 Stack trace: #0 {main} thrown in C:\xampp\htdocs\exam_mgt_codeThrive\add_school.php on line 22("s", $email);
    $stmt->execute();
