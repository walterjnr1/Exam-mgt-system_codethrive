...
if (empty($_SESSION['user_id'])) {
  ...
  $id= $_GET['id'];
  $stmt = $dbh->query("SELECT sst.id as st_id, u.name AS teacher, s.name AS subject, c.name AS class FROM subject_teacher st JOIN users u ON st.user_id = u.id JOIN subjects s ON st.subject_id = s.id
