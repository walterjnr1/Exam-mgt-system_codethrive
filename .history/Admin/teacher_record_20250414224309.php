                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php if($row['status'] == 1) { echo "<span style='color: green;'>Active</span>"; } else { echo "<span style='color: red;'>Inactive</span>"; }?></td>                    
                              <td>
            <?php if (($row['status'])==(('0')))  { ?>
              <a href="enable_disable_teacher.php?eid=<?php echo $row['id'];?>" onClick="return enable();">
        <i class="fa fa-check" aria-hidden="true" title="Enable Teacher"></i>
      </a>
              <?php } else {?>
                <a href="enable_disable_teacher.php?did=<?php echo $row['id'];?>" onClick="return disable();">
      <i class="fa fa-times" aria-hidden="true" title="Disable Teacher"></i>
      </a>					  
      <?php } ?>
      <a href="delete_teacher.php?id=<?php echo $row['id'];?>" onClick="return deldata();">
      <i class="fa fa-trash" aria-hidden="true" title="Delete Teacher"></i>
      </a>  
      <?php if ($row['id'] == $_SESSION['user_id']) { ?>
  <a href="edit_teacher?id=<?php echo $row['id'];?>">
