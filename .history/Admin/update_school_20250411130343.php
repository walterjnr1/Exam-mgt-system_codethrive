...
$image_name= addslashes($_FILES['imageInput']['name']);
$image_size= getimagesize($_FILES['imageInput']['tmp_name']);
move_uploaded_file($_FILES["imageInput"]["tmp_name"],"../uploadImage/Signature/" . $_FILES["imageInput"]["name"]);			
$Signature_path="uploadImage/Signature/" . $_FILES["imageInput"]["name"];
			
$sql = " update schools set headmaster_signature ='$Signature_path' where id='$school_id'";
   if (mysqli_query($conn, $sql)) {
    $_SESSION['success']='Signature_path Saved Successfully';
   }else{
      $_SESSION['error']='Problem Saving Logo';
}
}
              ...
              <form  action="" method="POST" >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <p align="center">
                    <img src="../<?php echo $row_school['headmaster_signature']; ?>" alt="school signature" id="logo-img" width="100" height="80" style="display: none;">
                    </p>
                   </div>
