...
$id = $_GET['id'];
$stmt = $dbh->query("SELECT * FROM users where id='$email'");
$row_user = $stmt->fetch();
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="txtname" class="form-control" id="exampleInputEmail1" value="<?php echo $row['name']; ?>">
                </div>
              
                <div class="form-group">
                    <label for="exampleInputEmail1">Role</label>
                    <select id="cmdrole" name="cmdrole" class="form-control">
                        <option value="<?php echo $row['role']; ?>" <?php echo $row['role']; ?>><?php echo $row['role']; ?></option>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="tel" name="txtphone" class="form-control" id="exampleInputPassword1" value="<?php echo $row['phone']; ?>">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" name="txtemail" class="form-control" id="exampleInputEmail1" value="<?php echo $row['email']; ?>">
                </div>
            </div>
        </div>
    </div>
