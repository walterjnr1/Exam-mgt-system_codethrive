...
}else if(isset($_POST["btncontact"]))
{
  ...
  $sql = " update schools set name='".$_POST['txtname']."',address='".$_POST['txtaddress']."',email='".$_POST['txt']."',phone1='".$_POST['name']."',phone2='".$_POST['name']."',box='".$_POST['name']."',district='".$_POST['name']."',gpsaddress='".$_POST['name']."' where id='$school_id'";
     if (mysqli_query($conn, $sql)) {
