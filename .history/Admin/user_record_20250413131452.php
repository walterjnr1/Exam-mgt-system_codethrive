...
<div class="card">
      ...
      <?php } ?>
      <a href="delete_user.php?id=<?php echo $row['id'];?>" data-toggle="modal" data-target="#modal-user-delete">    
        <i class="fa fa-trash" aria-hidden="true" title="Delete Record"></i>
                  ...
                  <?php $cnt=$cnt+1;} ?>
                  <div class="modal fade" id="modal-user-delete" tabindex="-1" role="dialog" aria-labelledby="modal-user-delete-label" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal-user-delete-label">Delete User</h5>
