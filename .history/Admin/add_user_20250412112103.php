...
if (isset($_POST['btnadd'])) {
  ...
  // Create user account
  $query = "INSERT INTO users (school_id,name, email, password, role, phone) VALUES ('$school_id','$name', '$email', '$password', '$role', '$phone')";
  $result = mysqli_query($conn, $query);
...
<p>You can now log in using your email address: <strong>$email</strong> , <br> school code: <strong>$school_code</strong> and <br>Password: <strong>$password</strong></p>
...
";
    ...
    $_SESSION['error']="Error: Unable to save data to database.";
  }
  }}
?>
