...
if (isset($_POST['btnadd'])) {
  // Sanitize inputs
  $name = mysqli_real_escape_string($conn, $_POST['cmdsubject']);
  $section = mysqli_real_escape_string($conn, $_POST['cmdclass']);
  $section = mysqli_real_escape_string($conn, $_POST['cmdteacher']);
