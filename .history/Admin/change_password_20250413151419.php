...
if(isset($_POST["btnchange"]))
{
  ...
  $oldPassword = $_POST['txtold_password'];
  ...
  if ($stmt->execute()) {
      ...
      try {
          ...
          <html>
          <head>
          <title>Password Update notification | Bizmall</title>
          </head>
          <body>
          ...
          <p>To log in, please visit: [https://bizmall.com.ng/login.php]</p>
          ...
          $mail->Subject = 'Password Update notification| Bizmall';
          $mail->Body = $message;
          $mail->send();

          $success = 'Password changed successfully. Please check your email.';

          //redirect to login.php after 1 sec
          header("refresh:3; url=login.php");

      } catch (Exception $e) {
          $error = 'Password could not be sent. Please try again later. ';
      }
  } else {
      $error = "Update failed.";
  }
              ...
              <form  action="" method="POST" >
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtoldpassword" class="form-control" id="exampleInputEmail1" value="<?php echo $_POST['txtoldpassword'] ?? ''; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">New Password</label>
                    <input type="text" name="txtnewpassword" class="form-control" id="exampleInputPassword1" value="<?php echo $_POST['txtnewpassword'] ?? ''; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Confirm Password</label>
                    <input type="email" name="txtconfirmpassword" class="form-control" id="exampleInputEmail1" value="<?php echo $_POST['txtconfirmpassword'] ?? ''; ?>">
                  </div>
