...
$id= $_GET['id'];
$stmt = $dbh->query("SELECT * FROM academic_session where id='$id'");
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="txtname" class="form-control" id="exampleInputEmail1" value="<?php echo $row_session['session']; ?>">
                </div>
              
                <div class="form-group">
                    <label for="exampleInputEmail1">Term</label>
                    <select id="cmdterm" name="cmdterm" class="form-control">
                        <option value="<?php echo $row_session['term']; ?>" <?php echo $row_session['term']; ?>><?php echo $row_session['term']; ?></option>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" name="txtstart" class="form-control" id="exampleInputPassword1" value="<?php echo $row_session['start']; ?>">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">End Date</label>
                    <input type="date" name="txtend" class="form-control" id="exampleInputEmail1" value="<?php echo $row_session['end']; ?>">
                </div>
            </div>
        </div>
    </div>
