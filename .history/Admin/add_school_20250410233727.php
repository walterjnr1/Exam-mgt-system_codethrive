...
}else if(isset($_POST["btncontact"]))
{
  ...
  $sql = " update schools set name='".$_POST['txyname']."',address='".$_POST['name']."',email='".$_POST['name']."',phone1='".$_POST['name']."',phone2='".$_POST['name']."',box='".$_POST['name']."',district='".$_POST['name']."',gpsaddress='".$_POST['name']."' where id='$school_id'";
     if (mysqli_query($conn, $sql)) {
