...
if (isset($_POST['btnadd'])) {
  ...
  // Validate inputs
      $query = "SELECT * FROM subject_teacher WHERE school_id = '$school_id' and user_id='$teacher' and subject_id='$subject' and class_id='$class'";
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          $query = "INSERT INTO subject_teacher (school_id, name, section) VALUES ('$school_id', '$name', '$section')";
          $result = mysqli_query($conn, $query);

          if ($result) {
          
      $_SESSION['success']= "subject Allocation created successfully!";
    }else {
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $query = "SELECT name FROM users WHERE role = 'Teacher' and school_id='$school_id'";
    $result = mysqli_query($conn, $query);
    ...
    ?>
       ...
       <?php 
    // Assuming you have a database connection established
    $query = "SELECT name FROM subjects WHERE school_id = '$school_id'";
    $result = mysqli_query($conn, $query);
    ...
    ?>
       ...
       <?php 
    // Assuming you have a database connection established
    $query = "SELECT name FROM classes WHERE school_id = '$school_id'";
    $result = mysqli_query($conn, $query);
