...
?>
  <tr>
    ...
    <td><?php echo htmlspecialchars($row['max_score']); ?></td>
        <td>
         <a href="delete_grade.php?id=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');">
        <i class="fa fa-trash" aria-hidden="true" title="Delete Grade Record"></i>
        </a>
        <a href="edit_grade.php?id=<?php echo $row['id'];?>">
        <i class="fa fa-edit" aria-hidden="true" title="Edit Grade Record"></i>
          </a>
        </td>
        </tr>
          <?php $cnt++; } ?>
