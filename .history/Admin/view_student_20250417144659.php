      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
           ...
           <img src="../<?php echo (!empty($row['photo'])) ? htmlspecialchars($row['photo']) : 'uploadImage/Profile/default.png'; ?>" width="70" height="50" style="object-fit:cover; border-radius:50%;" />
