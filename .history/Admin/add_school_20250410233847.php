...
}else if(isset($_POST["btnsignature"]))
{
  ...
  $headmaster_path="uploadImage/Signature/" . $_FILES["signatureInput"]["name"];
        
  $sql = " update schools set headmaster_signature='$headmaster_path' where id='$school_id'";
     if (mysqli_query($conn, $sql)) {
...
}else if(isset($_POST["btncontact"]))
{
  ...
  $sql = " update schools set name='".$_POST['txtname']."',address='".$_POST['txtaddress']."',email='".$_POST['txtemail']."',phone1='".$_POST['txtphone1']."',phone2='".$_POST['txtphone2']."',box='".$_POST['txtbox']."',district='".$_POST['cmddistrict']."',district='".$_POST['cmddistrict']."',gpsaddress='".$_POST['name']."' where id='$school_id'";
     if (mysqli_query($conn, $sql)) {
      $_SESSION['success']='Contact Saved Successfully';
     }else{district='".$_POST['cmddistrict']."'
        $_SESSION['error']='Problem Saving Contact';
  }
}
?>
      ...
      <div class="container-fluid">
              ...
              <form  action="" method="POST" >
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtname" class="form-control" id="exampleInputEmail1" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" name="txtphone1" class="form-control" id="exampleInputEmail1" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">phone 2</label>
                    <input type="tel" name="txtphone2" class="form-control" id="exampleInputPassword1" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">P.O.Box</label>
                    <input type="number" name="txtbox" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputPassword1">Region</label>
                    <select id="cmdregion" name="cmdregion" class="form-control" onchange="updateDistricts()">
                   <option value="">--Select Region--</option>
                    ...
                    <select id="cmddistrict" name="cmddistrict" class="form-control">
                    <option value="">--Select District--</option>
                    </select>
                    </div>

                    <div class="form-group">
                    <label for="exampleInputPassword1">Name of HeadMaster</label>
                    <input type="text" name="txtheadmastername" class="form-control" id="exampleInputPassword1" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">GPS Address</label>
                    <input type="text" name="txtgpsaddress" class="form-control" id="exampleInputPassword1" >
                  </div>
                  
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" btncontact class="btn btn-primary">Save Changes</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Headmistress/HeadMaster Signature</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <p align="center">&nbsp;</p>
                    <p align="center">
                    <img src="../<?php echo $school_photo; ?>" alt="signature" id="signature-img" width="100" height="80" style="display: none;">
                    </p>
                   </div>
                ...
                <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" name="btnsignature" class="btn btn-primary">Save Changes</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
