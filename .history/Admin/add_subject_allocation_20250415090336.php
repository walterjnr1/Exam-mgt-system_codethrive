...
if (isset($_POST['btnadd'])) {
  ...
  // Validate inputs
      $query = "SELECT * FROM subject_teacher WHERE teacher_id='$teacher' and subject_id='$subject' and class_id='$class' and school_id='$school_id'";
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          $query = "INSERT INTO subject_teacher (school_id,teacher_id, subject_id, class_id) VALUES ('$school_id','$teacher', '$subject', '$class')";
          $result = mysqli_query($conn, $query);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    ?>
       ...
       <?php 
    // Assuming you have a database connection established
    $query = "SELECT MIN(id) AS id, name FROM classes where school_id='$school_id' GROUP BY name ";
    $result = mysqli_query($conn, $query);
