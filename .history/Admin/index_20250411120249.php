      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h3 class="m-0 text-dark"><?php echo $row_school['name']; ?>, <?php echo $row_school['address']; ?>, <?php echo $row_school['region']; ?></h3>
