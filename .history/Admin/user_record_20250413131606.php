...
include 'delete_confirmation_modal.php'; 
...
<div class="card">
      ...
      <?php } ?>
      <a href="delete_user.php?id=<?php echo $row['id'];?>" onClick="return showDeleteConfirmationModal();">      <i class="fa fa-trash" aria-hidden="true" title="Delete Record"></i>
      </a>                     
     </td>
                  </tr>
                  <?php $cnt=$cnt+1;} ?>
...
<script>
  $('#confirm-delete').on('click', function() {
    ...
    $.ajax({
      ...
      success: function() {
        // Delete successful, refresh the page or update the UI
      }
    });
  });
</script>
