              ...
              <form  action="" method="POST" >
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtoldpassword" class="form-control" id="exampleInputEmail1" value="<?php echo $row_school['name'];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">New Password</label>
                    <input type="text" name="txtnewpassword" class="form-control" id="exampleInputPassword1" value="<?php echo $row_school['address'];?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Confirm Password</label>
                    <input type="email" name="txtconfirmpassword" class="form-control" id="exampleInputEmail1" value="<?php echo $row_school['email'];?>">
                  </div>
