...
}else if(isset($_POST["btncontact"]))
{
    ...
    if (mysqli_query($conn, $sql)) {
        header( "refresh:2;url= update_school" );
        $_SESSION['success']='Contact details Saved Successfully';
    } else {
        $_SESSION['error']='Problem Saving Contact details';
    }
}
?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <input type="text" name="txtname" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="<?php echo isset($_POST['txtname']) ? $_POST['txtname'] : ''; ?>">
</div>
<div class="form-group">
    <label for="exampleInputPassword1">Address</label>
    <input type="text" name="txtaddress" class="form-control" id="exampleInputPassword1" placeholder="Password" value="<?php echo isset($_POST['txtaddress']) ? $_POST['txtaddress'] : ''; ?>">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">Email</label>
    <input type="email" name="txtemail" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="<?php echo isset($_POST['txtemail']) ? $_POST['txtemail'] : ''; ?>">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">phone 1</label>
    <input type="tel" name="txtphone1" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="<?php echo isset($_POST['txtphone1']) ? $_POST['txtphone1'] : ''; ?>">
</div>
<div class="form-group">
    <label for="exampleInputPassword1">phone 2</label>
    <input type="tel" name="txtphone2" class="form-control" id="exampleInputPassword1" placeholder="Password" value="<?php echo isset($_POST['txtphone2']) ? $_POST['txtphone2'] : ''; ?>">
</div>
<div class="form-group">
    <label for="exampleInputEmail1">P.O.Box</label>
    <input type="number" name="txtpobox" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="<?php echo isset($_POST['txtpobox']) ? $_POST['txtpobox'] : ''; ?>">
</div>
                  <div class="form-group">
