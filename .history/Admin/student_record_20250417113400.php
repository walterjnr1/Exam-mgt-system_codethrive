...
<head>
  ...
  <script type="text/javascript">
		function enable(){
if(confirm("ARE YOU SURE YOU WISH TO ENABLE THIS STUDENT ?" ))
{
return  true;
}
else {return false;
...
<script type="text/javascript">
function disable(){
if(confirm("ARE YOU SURE YOU WISH TO DISABLE THIS STUDENT ?" ))
{
return  true;
}
else {return false;
...
<div class="card">
              <div class="card-header">
                <div>
                  ...
                  <a href="add_student"><button type="submit" name="btnadd" class="btn btn-primary">New Class</button></a>
