            ...
            <!-- /.card -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
$sql = " SELECT c.*, s.*, u.* FROM classes c INNER JOIN subjects s ON c.subject_id = s.id
INNER JOIN users u ON c.teacher_id = u.id WHERE c.school_id = '$school_id' ORDER BY c.id DESC
