      ...
      <div class="modal-body">
        <form id="assign-student-form">
          <div class="form-group">
            ...
            <input type="text" id="student-name" class="form-control" name="student_name" readonly>
          </div>
          <div class="form-group">
            <label for="class-id">Class:</label>
            <select id="class-id" name="class_id" class="form-control">
              <?php
              // Fetch classes from database
              $classes = mysqli_query($conn, "SELECT * FROM classes where school_id='$'");
