...
$sql = " update schools set logo='$logo_path' where id='$school_id'";
  ...
  $sql = "UPDATE schools SET name = ?,address = ?,email = ?,phone1 = ?,phone2 = ?,pobox = ?,region = ?,district = ? WHERE id = '$school_id'";
  $stmt = mysqli_prepare($conn, $sql);
  mysqli_stmt_bind_param($stmt, "ssssssss",$school_name,$school_address,$school_email,$school_phone1,$school_phone2,$school_pobox,$school_region,$school_district);
