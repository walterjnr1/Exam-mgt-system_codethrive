...
}else if(isset($_POST["btncontact"]))
{
  ...
  $sql = " update schools set name='.$_.',address='$headmaster_path',email='$headmaster_path',phone1='$headmaster_path',phone2='$headmaster_path',box='$headmaster_path',district='$headmaster_path',region='$headmaster_path',gpsaddress='$headmaster_path' where id='$school_id'";
     if (mysqli_query($conn, $sql)) {
