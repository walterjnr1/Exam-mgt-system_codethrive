      ...
      <?php } ?>       </td>
       <td>
        ...
        <i class="fa fa-eye" aria-hidden="true" title="View All Student Record"></i>
          ...
          <a href="assign_student.php?id=<?php echo $row['id'];?>">
  <i class="fa fa-user-plus action-icon" aria-hidden="true" title="Assign Student to Class"></i>
</a><a href="assign_class.php?id=<?php echo $row['id'];?>">
        <i class="fa fa-eye" aria-hidden="true" title="Assign Student to class"></i>
          </a>
        </td>
        </tr>
          <?php $cnt++; } ?>
