...
if (isset($_POST['btnadd'])) {
  ...
  $query = "SELECT id FROM teachers WHERE id = '$teacher'";
  $result = mysqli_query($conn, $query);
  if (mysqli_num_rows($result) == 0) {
    $_SESSION['error'] = "Invalid teacher ID";
  } else {
  // Validate inputs
      $query = "SELECT * FROM subject_teacher WHERE user_id='$teacher' and subject_id='$subject' and class_id='$class'";
      $result = mysqli_query($conn, $query);
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          $query = "INSERT INTO subject_teacher (user_id, subject_id, class_id) VALUES ('$teacher', '$subject', '$class')";
          $result = mysqli_query($conn, $query);
