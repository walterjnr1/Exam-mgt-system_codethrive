...
}else if(isset($_POST["btncontact"]))
{
  ...
  $sql = " update schools set name='$headmaster_path',address='$headmaster_path',email='$headmaster_path',phone1='$headmaster_path',phone2='$headmaster_path',box='$headmaster_path',district='$headmaster_path',name='$headmaster_path',name='$headmaster_path',name='$headmaster_path' where id='$school_id'";
     if (mysqli_query($conn, $sql)) {
