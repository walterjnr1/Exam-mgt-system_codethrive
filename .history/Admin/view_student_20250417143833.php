...
$student_id= $_GET['id'];
$stmt = $dbh->query("SELECT students.*, classes.name AS class FROM students INNER JOIN classes ON students.class_id=classes.id WHERE students.school_id='$school_id'");
$row_user = $stmt->fetch();
?>
