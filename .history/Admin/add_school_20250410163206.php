...
move_uploaded_file($_FILES["imageInput"]["tmp_name"],"../uploadImage/Profile/" . $_FILES["userImage"]["name"]);			
$location="uploadImage/Logo/" . $_FILES["imageInput"]["name"];
			
$sql = " update users set photo='$location' where email='$email'";
              ...
              <form  action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <p>
                      <input id="imageInput" name="imageInput" type="file" class="form-control" onChange="display_img(this)"/>
                    </p>
                    <p align="center">&nbsp;</p>
                    <p align="center">
