...
<div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                          $sql = "SELECT classes.*,users.*,users.name AS teacher FROM classes INNER JOIN users ON classes.user_id = users.id where classes.school_id='$school_id' order by id desc ";
