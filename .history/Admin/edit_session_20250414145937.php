        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" name="txtstart" class="form-control" id="exampleInputPassword1" value="<?php echo $row_user['phone']; ?>">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">End Date</label>
                    <input type="date" name="txtemail" class="form-control" id="exampleInputEmail1" value="<?php echo $row_user['email']; ?>">
                </div>
            </div>
        </div>
    </div>
