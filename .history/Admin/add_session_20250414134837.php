        ...
        <div class="row">
          ...
          <div class="col-md-12">
           ...
           <label for="exampleInputEmail1">Start date</label>
               <input type="date" name="txtstart" class="form-control" id="exampleInputEmail1" value="<?php echo $_POST['txtyear'] ?? ''; ?>">
                </div>
            
            </div>
            <div class="form-group">
           <label for="exampleInputEmail1">End Date</label>
               <input type="date" name="txtend" class="form-control" id="exampleInputEmail1" value="<?php echo $_POST['txtyear'] ?? ''; ?>">
                </div>
