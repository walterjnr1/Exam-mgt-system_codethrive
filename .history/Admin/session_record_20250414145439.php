      ...
      <div class="container-fluid">
       ...
       <div class="card">
              <div class="card-header">
                <div>
                  <h5>This Table contains data about SessionS</h5>
      <a href="add_user"><button type="submit" name="btnadd" class="btn btn-primary">New Session</button></a>
                </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                          $sql = "SELECT * FROM academic_session where school_id='$school_id' order by id asc ";
                  ...
                  <tr>
                    ...
                    <td>
        <a href="delete_session.php?id=<?php echo $row['id'];?>" onClick="return deldata();">
      <i class="fa fa-trash" aria-hidden="true" title="Delete Record"></i>
      </a>  
     <a href="edit_session?id=<?php echo $row['id'];?>">
