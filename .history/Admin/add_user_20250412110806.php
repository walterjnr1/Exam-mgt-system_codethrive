...
if (isset($_POST['btnadd'])) {
  ...
  }else // Check if password is more than 8 characters
...
<p>You can now log in using your email address: <strong>$email</strong> , school code: <strong>$school_id</strong> and Password: <strong>$password</strong></p>
