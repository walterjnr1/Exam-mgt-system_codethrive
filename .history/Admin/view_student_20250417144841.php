      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
           ...
           </p> <img src="../<?php echo (!empty($row['photo'])) ? htmlspecialchars($row['photo']) : 'uploadImage/Profile/default.png'; ?>" width="70" height="70" style="object-fit:cover; border-radius:50%;" />
