...
$student_id= $_GET['id'];
$stmt = $dbh->query("SELECT students.*, classes.name, classes.name AS class FROM students INNER JOIN classes ON students.class_id=classes.id WHERE students.id='$student_id$' and students.school_id='$school_id'");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            <!-- jquery validation -->
            <div class="card card-primary" id="student_data">
           ...
           <label for="exampleInputEmail1">Admission ID: <?php echo $row_student['admission_no']  ?></label>
            ...
            <div class="form-group">
           <label for="exampleInputEmail1">Class: <?php echo $row_student['class']  ?><?php echo $row_student['section']  ?></label>
            </div>
            <div class="form-group">
           ...
           <label for="exampleInputEmail1">Address: <?php echo $row_student['address']  ?></label>
            ...
            <div class="form-group">
           <label for="exampleInputEmail1">District: <?php echo $row_student['district']  ?></label>
            </div>
            <div class="form-group">
           <label for="exampleInputEmail1">Region: <?php echo $row_student['region']  ?></label>
            </div>
            <div class="form-group">
           <label for="exampleInputEmail1">Photo</label>
           <p> <img src="../<?php echo (!empty($row['photo'])) ? htmlspecialchars($row['photo']) : 'uploadImage/Profile/default.png'; ?>" width="70" height="70" style="object-fit:cover; border-radius:50%;" /></p>

            </div>
            <div class="form-group">
           <label for="exampleInputEmail1">Previous School: <?php echo $row_student['previous_school']  ?></label>
            </div>
            <div class="form-group">
           <label for="exampleInputEmail1">Status:  <?php if ($row['status'] == 1) { ?>
    ...
    <div class="card-footer">
        <button id="print" onClick="printdiv('student_data');" class="btn btn-sm btn-primary pull-right m-t-n-xs" ><i class="fa fa-print"></i> Print</button>
    </div>
</form>
            </div>
            <!-- /.card -->
