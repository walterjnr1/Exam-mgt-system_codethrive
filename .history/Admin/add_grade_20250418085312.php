...
if (isset($_POST['btnadd'])) {
  ...
  // Sanitize inputs
  $subject = mysqli_real_escape_string($conn, $_POST['cmdgrade']);
  $class = mysqli_real_escape_string($conn, $_POST['txtmax_score']);
  $teacher = mysqli_real_escape_string($conn, $_POST['txtmin_score']);

  
  // Validate inputs
      $query = "SELECT * FROM grades WHERE user_id='$teacher' and subject_id='$subject' and class_id='$class' and school_id='$school_id'";
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          $query = "INSERT INTO subject_teacher (school_id, min_score, max_score, grade, remark) VALUES ('$school_id', '$min_score', '$max_score', '$grade', '$remark')";
          $result = mysqli_query($conn, $query);
