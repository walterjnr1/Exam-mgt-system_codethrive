        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select name="class_id" class="form-control" required>
              ...
              <option value="B">-- Select Section --</option>
              <option value="C">-- Select Section --</option>
              <option value="D">-- Select Section --</option>
              <option value="E">-- Select Section --</option>
              <option value="F">-- Select Section --</option>
              <option value="G">-- Select Section --</option>
              <option value="H">-- Select Section --</option>
              <option value="I">-- Select Section --</option>
              <option value="J">-- Select Section --</option>
              <option value="K">-- Select Section --</option>
              <option value="L">-- Select Section --</option>
