...
<div class="card">
  ...
  <div class="modal-dialog">
    ...
    <td>
    <?php echo htmlspecialchars($row['teacher']); ?></td>
         <td>
         <a href="delete_class.php?id=<?php echo $row['id'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');">
        <i class="fa fa-trash" aria-hidden="true" title="Delete Student Record"></i>
          </a>
          <a href="edit_class.php" onClick="return deldata('<?php echo $row['fullname']; ?>');">
        <i class="fa fa-trash" aria-hidden="true" title="Delete Student Record"></i>
          </a>
