  ...
  <div class="modal-dialog">
    <form method="POST" action="">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label for="student_id" class="form-label">Select Teacher</label>
            <select name="teach_id" class="form-control" required>
              <option value="">-- Select Teacher --</option>
              <?php 
          $studentList = $dbh->query("SELECT * FROM users WHERE school_id='$school_id' AND class_id IS NULL")->fetchAll();               
