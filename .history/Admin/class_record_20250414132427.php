...
<div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                          $sql = "SELECT * FROM classes where school_id='$school_id' order by id asc ";
  ...
  <a href="edit_user?id=<?php echo $row['id'];?>"><i class="fa fa-edit" aria-hidden="true" title="Edit Record"></i>
  </a>
     </td>
                  </tr>
                  <?php $cnt=$cnt+1;} ?>
