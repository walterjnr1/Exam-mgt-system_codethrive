    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo !empty($row_school['logo']) ? '../' . $row_school['logo'] : '../uploadImage/Logo/gradeplus.jpeg'; ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block"><?php echo $row_school['name']; ?></a>
        </div>
      </div>
