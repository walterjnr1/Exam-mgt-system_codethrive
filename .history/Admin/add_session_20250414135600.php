...
if (isset($_POST['btnadd'])) {
  ...
  $start = mysqli_real_escape_string($conn, $_POST['txtyear']);
  $end = mysqli_real_escape_string($conn, $_POST['txtyear']);

  // Validate inputs
  
      $query = "SELECT * FROM academic_session WHERE session = '$name' and term='$term'";
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          $query = "INSERT INTO academic_session (school_id, session, term,start_date,end_date) VALUES ('$school_id', '$year', '$term','')";
          $result = mysqli_query($conn, $query);
