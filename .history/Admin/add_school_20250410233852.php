...
}else if(isset($_POST["btncontact"]))
{
  ...
  $sql = " update schools set name='".$_POST['txtname']."',address='".$_POST['txtaddress']."',email='".$_POST['txtemail']."',phone1='".$_POST['txtphone1']."',phone2='".$_POST['txtphone2']."',box='".$_POST['txtbox']."',district='".$_POST['cmddistrict']."',region='".$_POST['cmddistrict']."',gpsaddress='".$_POST['name']."' where id='$school_id'";
     if (mysqli_query($conn, $sql)) {
