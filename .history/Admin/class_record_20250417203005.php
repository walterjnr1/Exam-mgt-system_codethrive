...
<div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                          $sql = "SELECT classes.*,users.*,users.name AS teacher FROM classes INNER JOIN users ON classes.user_id = users.id where classes.school_id='$school_id' order by classes.id desc ";
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select name="teacher_id" class="form-control" required>
              ...
              <?php 
              $teacherList = $dbh->query("SELECT * FROM users WHERE role='Teacher' and school_id='$school_id'")->fetchAll();
              foreach ($teacherList as $teacher) {
                echo "<option value='".$teacher['id']."'>".$teacher['name']."".$teacher['section']."</option>";
              }
              ?>
            </select>
          </div>
