...
if (isset($_POST['btnadd'])) {
  ...
  // Validate inputs
      $query = "SELECT * FROM subject_teacher WHERE teacher_id='$teacher' and subject_id='$subject' and class_id='$class'";
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          $query = "INSERT INTO subject_teacher (teacher_id, subject_id, class_id) VALUES ('$teacher', '$subject', '$class')";
          $result = mysqli_query($conn, $query);
