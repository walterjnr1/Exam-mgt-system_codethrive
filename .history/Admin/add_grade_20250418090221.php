        ...
        <div class="row">
          ...
          <div class="col-md-12">
           ...
           <label for="exampleInputEmail1">Max Score</label>
               <input type="number" name="txtmax_score" class="form-control" id="exampleInputEmail1" value="<?php echo $_POST['txtname'] ?? ''; ?>" required>
                </div>
            
            </div>
            <div class="form-group">
           <label for="exampleInputEmail1">Min Score</label>
               <input type="number" name="txtmin_score" class="form-control" id="exampleInputEmail1" value="<?php echo $_POST['txtname'] ?? ''; ?>" required>
                </div>
