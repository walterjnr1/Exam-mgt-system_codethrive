...
if (isset($_POST['btnadd'])) {
  // Check if any dropdown list ID is empty
  if (empty($_POST['cmdsubject']) || empty($_POST['cmdclass']) || empty($_POST['cmdteacher'])) {
    $_SESSION['error'] = "Please select a valid option for all fields.";
  } else {
  // Sanitize inputs
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $result = mysqli_query($conn, $query);
    echo '<option value="-- Select Teacher -- "> -- Select Teacher -- </option>';
