        ...
        <div class="row">
            ...
            <div class="form-group">
                    ...
                    <select id="cmdsection" name="cmdsection" class="form-control">
                        <option value="<?php echo $row_class['section']; ?>" <?php echo $row_class['section']; ?>><?php echo $row_class['section']; ?></option>
                        <option value="Admin" <?php echo $_POST['cmdsection'] == 'Admin' ? 'selected' : ''; ?>>Admin</option>
                        <option value="Teacher" <?php echo $_POST['cmdsection'] == 'Teacher' ? 'selected' : ''; ?>>Teacher</option>
                    </select>
                </div>
            </div>
        </div>
