            ...
            <!-- /.card -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
            $sql = " SELECT c.*, s.*, u.* FROM classes c INNER JOIN subjects s ON c.subject_id = s.id INNER JOIN users u ON c.teacher_id = u.id WHERE c.school_id = '$school_id' ORDER BY c.id DESC ";									      	$result = $conn->query($sql);
            $cnt=1;
                  ...
                  <tr>
                    ...
                    <td>
      <a href="delete_subject.php?id=<?php echo $row['id'];?>" onClick="return deldata();">
      <i class="fa fa-trash" aria-hidden="true" title="Delete Record"></i>
      </a>  
  <a href="edit_subject?id=<?php echo $row['id'];?>"><i class="fa fa-edit" aria-hidden="true" title="Edit Record"></i>
  </a>
     </td>
                  </tr>
                  <?php $cnt=$cnt+1;} ?>
