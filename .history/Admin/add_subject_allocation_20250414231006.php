...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
           ...
           <select name="cmdteacher" class="form-control" id="exampleInputEmail1" req>
       <?php 
    ...
    ?>
           ...
           <select name="cmdsubject" class="form-control" id="exampleInputEmail1">
       <?php 
    // Assuming you have a database connection established
    ...
    ?>
           ...
           <select name="cmdclass" class="form-control" id="exampleInputEmail1">
       <?php 
    // Assuming you have a database connection established
