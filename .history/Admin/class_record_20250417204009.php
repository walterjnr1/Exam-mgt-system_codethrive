    ...
    <form method="POST" action="">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="assignClassLabel<?php echo $row['id']; ?>">Assign Teacher to <?php echo htmlspecialchars($row['name']); ?><?php echo htmlspecialchars($row['section']); ?></h5>
