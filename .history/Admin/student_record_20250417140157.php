...
<div class="card">
              <div class="card-header">
                <div>
                  ...
                  <h6 class="style1">Make you assign student to class first <a href="">
...
?>
  ...
  <div class="modal-dialog">
    <form method="POST" action="">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="assignClassModalTopLabel">Assign Class to Student</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="mb-3">
            ...
            <select name="student_id" class="form-control" required>
              ...
              <?php 
              $studentList = $dbh->query("SELECT id, fullname FROM students WHERE school_id='$school_id' AND (class_id IS NULL OR class_id = 0)")->fetchAll();
