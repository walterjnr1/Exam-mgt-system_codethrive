      ...
      <?php } ?>       </td>
       <td>
        ...
        <i class="fa fa-user-plus" aria-hidden="true" title="Assign Student to Class"></i>
          ...
          <!-- Modal Form -->
<div id="assignClassModal<?php echo $row['id']; ?>" class="modal fade" role="dialog">
<div class="modal fade" id="assignClassModal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="assignClassModalLabel" aria-hidden="true">
