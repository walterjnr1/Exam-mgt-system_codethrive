...
<head>
  ...
  <title><?php echo $app_name; ?> | Assign Class Teacher Record</title>
...
<div class="card">
              <div class="card-header">
                <div>
                  ...
                  <h6 class="style1">Make sure you assign teacher to class first 
              ...
              <div class="card-body">
                <table width="626" height="98" class="table table-bordered table-striped" id="example1">
                  ...
                  <tbody>
                  <?php 
        $data = $dbh->query("SELECT classes.*, users.name As teacher FROM classes INNER JOIN users ON classes.user_id=users.id WHERE classes.school_id='$school_id'")->fetchAll();
        $cnt = 1;
        foreach ($data as $row) {
        ?>
         <tr>
