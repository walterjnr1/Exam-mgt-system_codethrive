...
$student_id= $_GET['id'];
$stmt = $dbh->query("SELECT students.*, classes.name AS class FROM students INNER JOIN classes ON students.class_id=classes.id WHERE id='$student_id$' and students.school_id='$school_id'");
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
           ...
           <label for="exampleInputEmail1">Student Name : <?php echo $row_student['fullname']  ?></label>
            </div>
            <div class="form-group">
           ...
           <label for="exampleInputEmail1">Date of Birth:</label>
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Boarding Status: </label>
              </div>
              <div class="form-group">
