    ...
    <div class="form-container">
      ...
      <form  action="" method="POST" >
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control" name="txtemail" value="<?php echo $_POST['txtname'] ?? ''; ?>" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="txtpreviousschool" value ="Enter password" required>
        </div>
        <div class="d-grid">
