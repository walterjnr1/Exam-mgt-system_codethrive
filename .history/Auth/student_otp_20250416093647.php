...
if (isset($_POST['btnverify'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    //how to update status in students table
    $sql_student = "UPDATE students SET status=? where email=?";
...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
  ...
  <div class="card p-4 shadow-lg" style="max-width: 700px; width: 100%; height:40% " >
    ...
    <p class="text-center mb-4">OTP was sent to your Email (<?php echo $email  ; ?>) </p>
