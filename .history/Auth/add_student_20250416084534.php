...
if(isset($_POST["btnsave"]))
{
    ...
    //fetch school
    $stmt = $dbh->query("SELECT * FROM school where id='$user_id' and school_id='$school_id'");
...
<p>Thank you for registering with [Institution Name]. To complete your registration, please verify your email address using the One-Time Password (OTP) provided below:</p>
