...
if(isset($_POST["btnsave"]))
{
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO students (school_id, name, address, email,code) VALUES (?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
...
<html>
<head>
<title>School Registration notification | $app_name</title>
</head>
<body>
...
<div class="container">
    ...
    $query = "SELECT * FROM schools WHERE school_id = '$school_id' GROUP BY name ORDER BY name desc";
    ...
    ?>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="txtpreviousschool" value="<?php echo $_POST['txtpreviousschool'] ?? ''; ?>" required>
        </div>
        <div class="d-grid">
