...
if(isset($_POST["btnsave"]))
{
    ...
    //fetch school
    $stmt = $dbh->query("SELECT * FROM school where school_id='$school_id'");
    $row_school = $stmt->fetch();
    $school_name=$row_school['name'] ;
    $school_name=$row_school['district'] ;
...
<p>Thank you for registering with $row_school['name']. To complete your registration, please verify your email address using the One-Time Password (OTP) provided below:</p>

<p>Your OTP Code: [12345]</p>

<p>Please enter this code on the verification page to confirm your registration. This OTP is valid for the next 10 minutes.</p>

<p>If you did not initiate this registration, kindly ignore this email.</p>

<p>For any assistance, feel free to reach out to us at [Contact Email/Phone Number].</p>
