...
<p>Please enter this code on the verification page to confirm your registration. This OTP is valid for the next 15.</p>
...
";
        ...
        //save otp
        $sql = "INSERT INTO otps (school_id, admission_no, fullname, sex,dob,password,parent_email,parent_phone,previous_school) VALUES (?, ?,?,?,?,?, ?, ?,?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssssss", $school_id, $admission_no, $name, $sex,$dob,$hashedPassword,$email,$phone,$previous_school);
