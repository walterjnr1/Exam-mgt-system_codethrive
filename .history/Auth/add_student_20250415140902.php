...
<p>We are pleased to inform you that your registration has been successfully received for the  Academic Year / Semester, e.g., 2025/2026 Academic Year].</p>
...
<div class="container">
    ...
    ?>
        ...
        <div class="mb-3">
          <label for="fullname" class="form-label">Academic Session</label>
          <input type="text" class="form-control" name="txtsession" value="<?php echo $_POST['txtsession'] ?? ''; ?>" required>
        </div>
        <div class="mb-3">
