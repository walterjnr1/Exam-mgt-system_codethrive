...
if(isset($_POST["btnsave"]))
{
    ...
    if ($result->num_rows > 0) {
        ...
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssss", $school_id, $admission_no, $name, $sex,$dob,$password,$email,$phone,$previous_school);
...
<p>We are pleased to inform you that your registration has been successfully received for the [Program Name / Academic Year / Semester, e.g., 2025/2026 Academic Year].

<p>Registration Details:

<p>Name: [Student Name]

<p>Student ID: [Student ID, if applicable]

<p>Program: [Program Name]

<p>Department: [Department Name]

<p>Kindly ensure that all required documents are submitted to the registration office by [Deadline Date]. If you have not yet completed this process, please do so at your earliest convenience.

<p>For any inquiries or assistance regarding your registration, feel free to contact us at [Contact Email/Phone Number].

We look forward to having you as part of our academic community.
...
";
                ...
                $mail->Subject = "School Registration notification| $app_name";
                $mail->Body = $message;
                $mail->send();
