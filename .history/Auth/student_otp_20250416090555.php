...
if (isset($_POST['btnverify'])) {
  $otp = $_POST['otp'];
  $student_id = $_SESSION['admission_no']; // Assuming student ID is stored in session

  // Check if OTP is valid and not expired (15 minutes)
  $query = "SELECT * FROM otps WHERE student_id = '$student_id' AND otp = '$otp' AND TIMESTAMPDIFF(MINUTE, created_at, NOW()) < 15";
