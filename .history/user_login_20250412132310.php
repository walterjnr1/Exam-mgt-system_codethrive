...
if(isset($_POST['btnlogin']))
{
  ...
  $query = "SELECT u.id, u.email, u.password, u.school_id, s.code AS school_code FROM users u LEFT JOIN schools s ON u.school_id = s.id WHERE u.email = '$email' and u.school LIMIT 1";
